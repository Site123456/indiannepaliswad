fetch("./json/bieres.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholderbieres = document.querySelector("#bieres");
   let placeholderbigbieres = document.querySelector("#bigbieres");
   let bieres = "";
   let bigbieres = "";
...
.then(function(response){
   ...
   let placeholderchilli = document.querySelector("#chilli");
   let placeholderbigchilli = document.querySelector("#bigchilli");
   let chilli = "";
   let bigchilli = "";
   for(let product of products){
    chilli += `
   ...
   placeholderchilli.innerHTML = chilli;
   placeholderbigchilli.innerHTML = bigchilli;
});
...
fetch("./json/momos.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholdermomos = document.querySelector("#momos");
   let placeholderbigmomos = document.querySelector("#bigmomos");
   let momos = "";
   let bigmomos = "";
   for(let product of products){
    momos += `
   ...
   placeholdermomos.innerHTML = momos;
   placeholderbigmomos.innerHTML = bigmomos;
});
...
fetch("./json/vapeurs.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholdervapeurs = document.querySelector("#vapeurs");
   let placeholderbigvapeurs = document.querySelector("#bigvapeurs");
   let vapeurs = "";
   let bigvapeurs = "";
   for(let product of products){
    vapeurs += `
   ...
   placeholdervapeurs.innerHTML = vapeurs;
   placeholderbigvapeurs.innerHTML = bigvapeurs;
});
fetch("./json/veg.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholderveg = document.querySelector("#veg");
   let placeholderbigveg = document.querySelector("#bigveg");
   let veg = "";
   let bigveg = "";
   for(let product of products){
    veg += `
...
fetch("./json/vins1.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholdervins1 = document.querySelector("#vins1");
   let placeholderbigvins1 = document.querySelector("#bigvins1");
   let vins1 = "";
   let bigvins1 = "";
   for(let product of products){
    vins1 += `
   ...
   placeholdervins1.innerHTML = vins1;
   placeholderbigvins1.innerHTML = bigvins1;
});
fetch("./json/vins2.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholdervins2 = document.querySelector("#vins2");
   let placeholderbigvins2 = document.querySelector("#bigvins2");
   let vins2 = "";
   let bigvins2 = "";
   for(let product of products){
    vins2 += `
   ...
   placeholdervins2.innerHTML = vins2;
   placeholderbigvins2.innerHTML = bigvins2;
});
fetch("./json/vins3.json")
.then(function(response){
   return response.json();
}).then(function(products){
   let placeholdervins3 = document.querySelector("#vins3");
   let placeholderbigvins3 = document.querySelector("#bigvins3");
   let vins3 = "";
   let bigvins3 = "";
   for(let product of products){
    vins3 += `
   ...
   placeholdervins3.innerHTML = vins3;
   placeholderbigvins3.innerHTML = bigvins3;
});
